...
import { AssessmentArt } from "./Artwork";
    ...
    <section className="section assessment" id="assessment">
      <div className="container">
        ...
        <div className="assessment__layout">
          <form className="assessment__card anim-slideR" onSubmit={submit}>
            ...
            <button type="submit" className="btn btn-accent assessment__submit">
              {t("assessment.cta")}
              <svg
          ...
          <div className="assessment__media anim-slideL">
            <img src="/assets/running_man.gif" alt="Running" className="assessment__art" style={{ width: "100%", height: "auto", objectFit: "contain", filter: "drop-shadow(0 20px 30px rgba(0,0,0,0.15))" }} />
          </div>
        </div>

        <p className="assessment__meta anim-rise">{t("assessment.meta")}</p>
