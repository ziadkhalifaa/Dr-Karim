...
export function AuthProvider({ children }) {
  ...
  return <AuthContext.Provider value={{ user, loading, error, setError, login, logout, refresh, authenticated: Boolean(user), authError: error instanceof ApiError ? error : null }}>{children}</AuthContext.Provider>;
}
